...
class SearchArea extends Component {
	constructor(props) {
		...
		this.baseUrl = 'http://crow.cs.illinois.edu:7002/';
   	...
   	render(){
   		...
   		let DocumentResult=(
				 	...
				 	{output.map((item,i)=> 
							...
							<Grid columns='equal'>
								<Grid.Column width={5}>
                                    <img src={"./assets/screenshots/" + crypto.createHash('md5').update(item._source.url).digest('hex') + ".png"} style={{width:'100%'}} alt="Image not found" onError="this.onerror=null;this.src='./assets/documentation.png';"/>
								</Grid.Column>
